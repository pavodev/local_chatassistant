...
define(['jquery', 'https://cdn.jsdelivr.net/npm/marked/marked.min.js'], function($, marked) {
    return {
      init: function() {
        // Chat button
        ...
        $form.on('submit', function(e) {
          ...
          const userMessage = $('<div class="chat-message user"></div>').css({
            'margin': '10px 0',
            'padding': '8px 12px',
          ...
          // Loader
          var $loader = $('<div class="chat-loader"></div>');
          $chatContent.append($loader);
          $chatContent.scrollTop($chatContent[0].scrollHeight);
